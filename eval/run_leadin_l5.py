#!/usr/bin/env python3
"""Run the L5 lead-in battery straight against the Forge debug API.

Usage:
  FORGE_TOKEN=... python3 eval/run_leadin_l5.py [--model gpt-5-mini] [--only case-id]
"""
import argparse
import json
import os
...
STEP_FILES = {
    "pre_video": "prompts/l5/leadin_teaching_rules_l5_step_pre_video.md",
    "post_video": "prompts/l5/leadin_teaching_rules_l5_step_post_video.md",
}
DEFAULT_NAME = "tom"
...
def main():
    ...
    battery = yaml.safe_load((ROOT / "eval/cases_leadin_l5.yaml").read_text())
