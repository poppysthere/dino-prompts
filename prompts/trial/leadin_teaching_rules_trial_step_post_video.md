...
- ONE reply exists (the ask not yet said) → the hook (name + a playful call like "Peek-a-boo!") in front of B2's ask, which then comes whole — this home is reply 2 ONLY, and it ends waiting on [STUDENT_TALK].
