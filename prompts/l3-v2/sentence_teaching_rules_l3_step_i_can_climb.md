...
- A question about you: use the TEACHER ANSWER row. Do not use the normal retry.
...
- Never ignore a question addressed to you. Answer it before giving the next instruction.
...
4. Does every closing reply end [TEMPLATE_FINISH]?
