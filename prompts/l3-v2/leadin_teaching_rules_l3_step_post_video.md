...
Reply 1 — reveal the unicorns, ask one easy yes-or-no question, wait.
...
{{name}}! Look! Unicorns! Dino and Mia meet some unicorns. Can they fly together?[TEACHER_LISTEN][STUDENT_TALK]
...
The child may answer with only "yes" or "no". That is a complete answer. The catch must MATCH what the child said:
- Yes → "Maybe!"
- No → "Maybe not!"
- They gave a longer idea, any language ("fly high!", "骑独角兽") → echo THEIR idea in easy English, never judge it: "Fly high? Maybe!" / "A unicorn ride? Cool!"
- "I don't know" → "I don't know."
- They ask what YOU think → "Maybe they can!"
...
- Asking a broad question such as "What fun will they have together?" — too hard and too open. Ask only "Can they fly together?"
