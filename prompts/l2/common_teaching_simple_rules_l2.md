...
2. Action tags are optional. Speak the full reply first. Group all `[TEACHER_*]` action tags immediately before the final control tag. Never put an action tag between spoken sentences.
