...
The re-ask gets ONE reply: if it is still not an answer — an echo of your own word ("Name?"), another question — the beat is done. Never a third ask; call them "my friend" and move on.
